function paces2(x, a, b, c) {


    var tempB = b / 100;
    document.getElementById('degreeResult2').innerHTML = x
    document.getElementById('pacesResult2').innerHTML = a
    document.getElementById('scaleResultX').innerHTML = b
    var dipdirection = document.getElementById('select112').value;
